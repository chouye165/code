...
const helpContent = {
	shellType: {
		header: '烟花类型',
		body: '将要发射的烟花类型。选择"随机"可以获得多种多样的组合！'
	},
	shellSize: {
		header: '烟花大小',
		body: '烟花的大小。基于真实烟花弹大小设计，更大的烟花有更大的爆炸效果和更多的星星，有时还有更复杂的效果。但是，更大的烟花也需要更多的处理能力，可能会导致延迟。'
	},
	quality: {
		header: '画质',
		body: '整体图形质量。如果动画运行不流畅，请尝试降低画质。高质量会大幅增加渲染的火花数量，可能会导致延迟。'
	},
	skyLighting: {
		header: '天空照明',
		body: '在烟花爆炸时照亮背景。如果背景在你的屏幕上看起来太亮，请尝试设置为"暗淡"或"无"。'
	},
	scaleFactor: {
		header: '缩放',
		body: '允许缩放所有烟花的大小，基本上是让你靠近或远离。对于较大的烟花尺寸，稍微缩小缩放比例会很方便，特别是在手机或平板上。'
	},
	autoLaunch: {
		header: '自动发射',
		body: '自动发射烟花序列。坐下来享受表演，或禁用以获得完全控制。'
	},
	finaleMode: {
		header: '终场模式',
		body: '发射密集的烟花爆发。可能会导致延迟。需要启用"自动发射"。'
	},
	hideControls: {
		header: '隐藏控制',
		body: '隐藏屏幕顶部的半透明控制按钮。对截图有用，或为了更无缝的体验。隐藏时，你仍然可以点击右上角重新打开此菜单。'
	},
	fullscreen: {
		header: '全屏',
		body: '切换全屏模式。'
...
// Note this is only random when "随机" shell is selected in config.
// Also, this does not create the shell, only returns the factory function.
const fastShellBlacklist = ['落叶', '花朵', '柳树'];
